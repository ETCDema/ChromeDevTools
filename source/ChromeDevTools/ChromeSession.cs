...
namespace MasterDevs.ChromeDevTools
{
	public class ChromeSession : IChromeSession
	{
		...
		private Action<byte[]> _onUnknownData;
		private Action<string> _onUnknownMessage;
		...
		public void SubscribeUnknown(Action<byte[]> onUnknownData, Action<string> onUnknownMessage)
		{
			_onUnknownData      = onUnknownData;
